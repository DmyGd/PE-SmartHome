...
class WebServer(BaseHTTPRequestHandler):
    ...
    def _parse_post(self, json_obj):
        ...
        print(json_obj)
        if 'reset' in json_obj:
            func = reset_control
            print('\tCall{}({})'.format(func, json_obj['reset']))
            func(json_obj['reset'])

        if 'camaras' in json_obj:
            func = cam_control
            print('\tCall{}({})'.format(func, "cam_control"))
            func(json_obj['camaras'])
        ...
        if 'timbre' in json_obj:
            func = bell_control
            print('\tCall{}({})'.format(func, json_obj['timbre']))
            func(json_obj['timbre'])

        if 'puertas' in json_obj:
            func = door_control
            print('\tCall{}({})'.format(func, json_obj['puertas']))
            func(json_obj['puertas'])
